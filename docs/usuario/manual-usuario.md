...
![Inicio de sesión](../assets/screenshots/inicio-sesion.png){ .screenshot }
...
![Registro](../assets/screenshots/registro-establecer-contrasena.png){ .screenshot }
...
![Pantalla principal del mapa](../assets/screenshots/inicio-mapa.png){ .screenshot }

## Búsqueda de ubicación

La búsqueda de ubicación permite centrar el mapa en una dirección o zona específica.

![Búsqueda de ubicación](../assets/screenshots/busqueda-de-ubicacion.png){ .screenshot }
...
![Formulario agregar tienda](../assets/screenshots/formulario-agregar-tienda.png){ .screenshot }
...
![Información de tienda](../assets/screenshots/informacion-tienda.png){ .screenshot }
...
![Editar tienda](../assets/screenshots/editar-tienda.png){ .screenshot }

![Formulario editar tienda](../assets/screenshots/formulario-editar-tienda.png){ .screenshot }
...
![Agregar oferta](../assets/screenshots/agregar-oferta.png){ .screenshot }

## Editar o eliminar oferta

Las ofertas existentes pueden editarse o eliminarse desde el menú de opciones de cada oferta.

![Editar o eliminar oferta](../assets/screenshots/editar-o-eliminar-oferta.png){ .screenshot }

![Formulario editar oferta](../assets/screenshots/formulario-editar-oferta.png){ .screenshot }

## Favoritos

El usuario puede marcar una tienda como favorita utilizando el ícono de corazón en el detalle de la tienda.

![Agregar tienda a favoritos](../assets/screenshots/agregar-tienda-a-favoritos.png){ .screenshot }

El módulo de favoritos muestra las tiendas guardadas por el usuario autenticado.

![Módulo favoritos](../assets/screenshots/modulo-favoritos.png){ .screenshot }

## Módulo de ofertas

El módulo de ofertas permite consultar las promociones registradas y buscar ofertas por nombre.

![Módulo ofertas](../assets/screenshots/modulo-ofertas.png){ .screenshot }

![Buscar oferta por nombre](../assets/screenshots/buscar-oferta-por-nombre.png){ .screenshot }

## Módulo de tiendas

El módulo de tiendas muestra las tiendas registradas y permite buscar por nombre, departamento o municipio.

![Módulo tiendas](../assets/screenshots/modulo-tiendas.png){ .screenshot }

![Buscar tienda por nombre](../assets/screenshots/buscar-tienda-por-nombre.png){ .screenshot }

![Buscar tienda por departamento](../assets/screenshots/buscar-tienda-por-departamento.png){ .screenshot }
...
![Mapa de calor](../assets/screenshots/Button-mapas-calor.png){ .screenshot }

![Mostrar mapas de calor](../assets/screenshots/modulo-mapas-calor.png){ .screenshot }
...
![Escribir reseñas](../assets/screenshots/modulo-reseñas.png){ .screenshot }
